    ...
    private static ParticleRenderType makeRenderType(ResourceLocation gradient, String name) {
        return new ParticleRenderType() {
            ...
            public void begin(BufferBuilder builder, TextureManager textureManager) {
                ...
                ShaderInstance shader = CECClientShaders.getEnergyMuzzleParticleShader();
                if (shader != null) {
            ...
            *///?} else {
            ...
            public BufferBuilder begin(Tesselator tesselator, TextureManager textureManager) {
                ...
                if (shader != null) {
                    RenderSystem.setShaderTexture(3, gradient);
                    RenderSystem.setShader(() -> shader);
                    return tesselator.begin(VertexFormat.Mode.QUADS, CECVertexFormats.PARTICLE_WITH_OVERLAY);
                } else {
                    RenderSystem.setShader(GameRenderer::getParticleShader);
